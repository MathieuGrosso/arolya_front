export default function CheckIcon1(props: CheckIcon1Props) {
  return (
    <div className="w-5 h-5 absolute left-[737px] top-[246px]">
      <svg
        width="100%"
        height="100%"
...
CheckIcon1.defaultProps = {};

interface CheckIcon1Props {}
