...
import { useReferenceByUserIdQuery, ReferenceByUserIdQuery, ReferenceByUserIdQueryVariables } from "../utils/__generated__/graphql";
...
export const BottomBar = (props : BottomBarProps) => {
	...
	<section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
		<div id="tabs" className="flex justify-between">
            ...
            <span className="text-right text-black font-bold font-['Lexend'] ">
            
                COUT DE LA COMMANDE:
				<br/>
				
				{data?.referenceByUserId?.references?.reduce((initialValue:number, item:any) => initialValue + item.p_sold*item.ordered, 0)} €
